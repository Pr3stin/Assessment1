...
const analysisOfRequirements = "Determine what the application is supoosed to do and dfining resourses needed to build the project."
const design = "Models the way the application will work and look."
const implementation = "The actual writing of the program. The development process. The code."
const testingAndIntegration = "Testing the application for any bugs and problems with the code."
const maintain = "The application has now been deployed and new features are being added and any bugs users are coming across are being fixed."